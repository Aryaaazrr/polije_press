    ...
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('admin.editor') }}">Tugas Editor</a></li>
                    ...
                    <div class="card-body">
                        ...
                        <div class="tab-content pt-2" id="borderedTabJustifiedContent">
                            <div class="tab-pane fade show active" id="bordered-justified-home" role="tabpanel"
                                ...
                                <form class="row g-3 " action="{{ route('admin.editor.update', $id) }}" id="stepForm"
        ...
        <script>
            $(document).ready(function() {
                $('#myTable').DataTable({
                    ...
                    serverSide: true,
                    ajax: {
                        url: '{{ route('admin.editor.data', ['id' => ':id']) }}'.replace(':id', window.location
                            .href.split('/').pop()), // Menggunakan id editor dari URL
                        method: 'GET', // Atau sesuaikan dengan metode yang digunakan dalam rute Anda
                        dataSrc: 'data' // Atau sesuaikan dengan properti yang berisi data dalam respons JSON Anda
                    },
                    columns: [{
                            data: 'DT_RowIndex',
                            name: 'DT_RowIndex',

    ...
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('pengelola.naskah') }}">Naskah</a></li>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        @endif
                        <form class="row g-3 mt-0" action="{{ route('admin.naskah.update', $buku->id_buku) }}"
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-floating">
                                    <input type="text" class="form-control" id="floatingSubjudul" placeholder="Subjudul"
                                        name="subjudul" value="{{ $buku->subjudul }}" required>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-floating">
                                    <textarea class="form-control" placeholder="Leave a comment here" id="floatingTextarea" name="abstrak"
                                        value="{{ $buku->abstrak }}" style="height: 100px;" required>{{ $buku->abstrak }}</textarea>
            ...
            <div class="modal fade" id="komentar" tabindex="-1">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <form class="row g-3 mt-0" action="{{ route('pengelola.naskah.store') }}" id="stepForm"
            ...
            <script>
                $(document).ready(function() {
                    var table = $('#myTableModal').DataTable({
                        ...
                        select: true,
                        processing: true,
                        ajax: '{{ route('pengelola.naskah.datauser') }}',
                        columns: [{
                                data: 'name',
                                name: 'name'
                            },
